...
void FloydWarshall_recurD(int n, int k, int i, int j, int size)
{
        ...
        else
        {
            ...
            {
                FloydWarshall_recurD(n, k, i, j, size);
            }

            #pragma omp task firstprivate(n, k, i, j, size)
            {
                FloydWarshall_recurD(n, k, i, j+size, size);
            }
            #pragma omp task firstprivate(n, k, i, j, size)
            {
                FloydWarshall_recurD(n, k, i+size, j, size);
            }
            #pragma omp task firstprivate(n, k, i, j, size)
            {
            ...
            #pragma omp task firstprivate(n, k, i, j, size)
            {
                FloydWarshall_recurD(n, k+size, i, j+size, size);
            }
            #pragma omp task firstprivate(n, k, i, j, size)
            {
                FloydWarshall_recurD(n, k+size, i+size, j, size);
            }
            #pragma omp task firstprivate(n, k, i, j, size)
            {
                FloydWarshall_recurD(n, k+size, i+size, j+size, size);
            }
            #pragma omp taskwait
    }
}
