...
void FloydWarshall_recur1(int n, int k, int i, int j, int size)
{
	...
	else
	{
        ...
        cilk_spawn FloydWarshall_recur1(n, k, i, j+size, size);
        cilk_spawn FloydWarshall_recur1(n, k, i+size, j, size);
        cilk_sync;
        FloydWarshall_recur1(n, k, i+size, j+size, size);
        FloydWarshall_recur1(n, k+size, i+size, j+size, size);
        cilk_spawn FloydWarshall_recur1(n, k+size, i+size, j, size);
        cilk_spawn FloydWarshall_recur1(n, k+size, i, j+size, size);
        cilk_sync;
